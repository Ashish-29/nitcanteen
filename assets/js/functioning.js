...
var firebaseConfig = {
  apiKey: "AIzaSyACazJCcARTk1c8LEDvXU44lbn4lcENaOQ",
  authDomain: "nitcanteen-208bd.firebaseapp.com",
  projectId: "nitcanteen-208bd",
  storageBucket: "nitcanteen-208bd.appspot.com",
  messagingSenderId: "341807698330",
  appId: "1:341807698330:web:ba67aa3c880e393ec72a23",
  measurementId: "G-1STED3SJEF",
};
...
class signUpMethods {
    ...
    if (password != repassword || password === "") {
      ...
      firebase
        ...
        .then((cred) => {
          ...
          saveDatabase.UserfirebaseDatabase(
            userName,
            email,
            password,
            phoneNumber
          ...
          Swal.fire({
            icon: "success",
            title:
              "Account Created Successfully. Please LogIn To order Delicious Cuisine",
          });
        })
  ...
  static authRedirecting() {
    window.setTimeout(() => {
      window.location.replace("https://nitcanteen.netlify.app/client-side");
    }, 500);
  }
        ...
        firebase
          ...
          .then(() => {
            window.location.replace(
              "https://nitcanteen.netlify.app/index.html"
            );
          });
      });
    });
