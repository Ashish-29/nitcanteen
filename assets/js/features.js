  ...
  previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">NIT</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
var bestDishes = [
  ...
  },
  {
    title: "Samosa",
    rating: 5.0,
    imgURL: "assets/images/samosa.jpg",
    description:
      "Sumptuous delicious food baked in our cafe with curated ingredients",
    price: 10,
  }
  ...
  signUp_UI = signUpModal.innerHTML = `
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">NIT</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>National Institute of Technology Jamshedpur (NIT Jamshedpur or NITJSR), 
                        is an Institute of National Importance for Technical Education located at 
                        Jamshedpur, Jharkhand, India. Established as a Regional Institute of 
                        Technology on 15 August 1960, it was upgraded to National Institute of 
                        Technology (NIT) on 27 December 2002 with the status of a Deemed University. 
                        It is one of the 31 NITs in India, and as such is directly under the control 
                        of the Ministry of Education (MHRD). It is the third in the chain of 8 NITs 
                        established as a part of the Second Five Year Plan (1956–61) by the 
                        Government of India.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/NITJamshedpurOfficial" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/nitjamshedpur_official/?igshid=NTdlMDg3MTY=" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://github.com/Ashish-29/nitcanteen" target="_blank">Git Repository</a></li>
                            <li><a href="https://nitjsr.ac.in/" target="_blank">NIT Jamshedpur</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-8917418799</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>admission@nitjsr.ac.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Adityapur, Jamshedpur (JH)-831014</p></li>
                ...
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">2K20 Batch</a></div>
                </main>
            </section>
        `;
    });
